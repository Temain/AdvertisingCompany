define([
    ...
    'text!/areas/admin/app/components/campaigns/create.html'
    ...
    var CreateCampaignViewModel = function(params) {
        ...
        self.init = function() {
            ...
            $.ajax({
                method: 'get',
                url: '/api/admin/clients/' + clientId + '/campaigns/0',
        ...
        self.submit = function() {
            ...
            $.ajax({
                method: 'post',
                url: '/api/admin/clients/' + self.clientId() + '/campaigns',
                data: postData,
                contentType: "application/json; charset=utf-8",
                headers: {
                    'Authorization': 'Bearer ' + app.getAccessToken()
    ...
    var createCampaign = new CreateCampaignViewModel();
    ...
    return { viewModel: { instance: createCampaign }, template: template };
});